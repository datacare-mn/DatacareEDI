...
class Contact extends React.Component<WeatherForecastProps, void> {
    componentWillMount() {
    ...
    private renderPagination() {
        ...
        return <p className='clearfix text-center'>
            <Link className='btn btn-default pull-left' to={ `/contact/${prevStartDateIndex}` }>Previous</Link>
            <Link className='btn btn-default pull-right' to={ `/contact/${nextStartDateIndex}` }>Next</Link>
